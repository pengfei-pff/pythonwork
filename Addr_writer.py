#data = {"_key":"7528880","_id":"Addr/7528880","_rev":"_YueDE9O--_","value":"南京秦淮区贡院街99号","link_type":202,"type":[221]}
...
def writer_file():
    ...
    for i in range(1000):
        ...
        # finall ={"_key": str(i), "_id": "Addr/" + str(i),"value":v_code(), "createDate": date, "link_type": 101}
        finall ={"_key": str(i+1), "_id": "Addr/" + str(i+1),"value":"北京市"+addr(), "link_type": 202,"type": [221]}
        json_str = json.dumps(finall, ensure_ascii=False,sort_keys=True)
        print(json_str)
        with codecs.open(r'F:\TEST3\Addr.jsonl', 'a',
