#data = {"_key":"7518850","_id":"workName/7518850","_rev":"_YpA3moi---","value":"高淳县固城镇士振编织袋加工厂","link_type":205}
import random
import time
...
def addr():
    ...
    for i in range(random.randint(10,20)):
        result = random.choice(StringBase)+result
    return result
...
def writer_file():
    ...
    for i in range(100):
        ...
        # finall ={"_key":"7518850","_id":"workName/7518850","value":"高淳县固城镇士振编织袋加工厂","link_type":205}
        finall ={"_key": str(i+1), "_id": "workName/" + str(i+1),"value":addr(), "link_type":205}
        json_str = json.dumps(finall, ensure_ascii=False)
        print(json_str)
        with codecs.open(r'F:\TEST2\workName.jsonl', 'a',
